...
public class FindFriends {
	...
	public void testHas() {
		...
		// THE TEST
		List l2 = itemDAO.findFriendsItems(authenticated, 0);
		assertNotNull(l2);
	...
	public void testItemBelongsToSelf() {
		...
		// THE TEST
		List l2 = itemDAO.findFriendsItems(person, 0);
		assertNotNull(l2);
		assertEquals(0, l2.size());
		// assertEquals(Item.class, l2.get(0).getClass());
	}
	...
	public void testDontHaveByCategory() {
		...
		// No item category
		List l2 = itemDAO.findFriendsItems(person, 0, CategoryType.RECOMMEND);
		assertNotNull(l2);
		assertEquals(0, l2.size());
	}
	...
	public void testHasByTag() {
		...
		// No item category
		List l2 = itemDAO.findFriendsItems(authenticated, Arrays
	...
	public void testDontHaveByTag() {
		...
		// No item category
		List l2 = itemDAO.findFriendsItems(person, Arrays
				.asList(new String[] { "Khim" }), 0);
		assertNotNull(l2);
		assertEquals(0, l2.size());
	}
	...
	public void testHasByCategoryAndTag() {
		...
		// No item category
		List l2 = itemDAO.findFriendsItems(authenticated, Arrays
				.asList(new String[] { "Khim" }), 0, CategoryType.RECOMMEND);
		assertNotNull(l2);
		assertEquals(1, l2.size());
	}
