...
<script type="text/javascript">	 		
	...
	function pleaseLogIn(){
		Boxy.alert('You must log in before using this feature.');
	}
	
</script>

<c:set var="isLoggedIn" value="no" />
	<sec:authorize ifAllGranted="ROLE_USER, ROLE_ADMIN, ROLE_MERCHANT,ROLE_ADS">
	  <c:set var="isLoggedIn" value="yes"/>
			...
			<table id="take-action-on-item-page-parent-element" style="display:none;">
				<tr><td style="color:red;">Please log in to use this feature.</td></tr>
				<tr>
					<td>
						Choose One: 
