...
<script type="text/javascript">	
					...
					submitHandler : function(form) {
						jQuery(form).ajaxSubmit( {
							...
							success: function(address) {
								...
								$('#billing-address-selection').append('<option value="' + address.id + '" selected="selected">'+address.street1+'</option>');
								$('#shipping-address-selection').append('<option value="' + address.id + '" selected="selected">'+address.street1+'</option>');
	...
	<form id="add-address-form">
		...
		<div>
			<div><span class='errors'>*</span><label for="street1">Street1</label></div>
			...
			<div><span class='errors'>*</span><label for="city">City</label></div>
			<div><input type="text" id="city" name="city"/></div>
			<div><span class='errors'>*</span><label for="state">State/Provance</label></div>
			<div><select id="stateOrProvince" name="stateOrProvince" size="1"><%@ include file="../account/address/state.jsp" %></select></div>
			<div><span class='errors'>*</span><label for="zip">Zip/Postal Code</label></div>
			<div><input type="text" id="postalCode" name="postalCode"/></div>
			<div><span class='errors'>*</span><label for="addressType">Address Type</label></div>
			...
			<div><span class='errors'>*</span><label for="country">Country</label></div>
