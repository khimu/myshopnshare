...
public class SellOrderController extends MultiActionController {
	@Autowired
	...
	public ModelAndView view(HttpServletRequest request,
		...
		request.setAttribute("orders", orderService.findAllOrderFor(person));
		request.setAttribute("statuses", OrderStatus.values());
		return new ModelAndView("orders/sells");
	}
	...
	public ModelAndView get(HttpServletRequest request,
		...
		OrderDetail order = orderService.get(Long.parseLong(orderDetailId));
