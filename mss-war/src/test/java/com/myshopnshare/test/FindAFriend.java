...
public class FindAFriend {
	...
	public void testHas() {
		...
		// THE TEST
		List l2 = itemDAO.findFriendItems(person, authenticated, 0);
		assertNotNull(l2);
	...
	public void testDontHave() {
		...
		// THE TEST
		List l2 = itemDAO.findFriendItems(authenticated, authenticated, 0);
		assertNotNull(l2);
	...
	public void testItemBelongsToSelf() {
		...
		// THE TEST
		List l2 = itemDAO.findFriendItems(person, person, 0);
		assertNotNull(l2);
		assertEquals(0, l2.size());
		// assertEquals(Item.class, l2.get(0).getClass());
	}
	...
	public void testHasByCategory() {
		...
		// THE TEST
		List l2 = itemDAO.findFriendItems(person, CategoryType.RECOMMEND,
				authenticated, 0);
		assertNotNull(l2);
		assertEquals(1, l2.size());
		assertEquals(Item.class, l2.get(0).getClass());
	...
	public void testDontHaveByCategoryMissing() {
		...
		// No item category
		List l2 = itemDAO.findFriendItems(authenticated,
				CategoryType.RECOMMEND, person, 0);
		assertNotNull(l2);
		assertEquals(0, l2.size());
	}
	...
	public void testHasByTag() {
		...
		// No item category
		List l2 = itemDAO.findFriendItems(person, authenticated, Arrays
	...
	public void testHasByCategoryAndTag() {
		...
		// No item category
		List l2 = itemDAO.findFriendItems(person, CategoryType.RECOMMEND,
				authenticated, Arrays.asList(new String[] { "Khim" }), 0);
		assertNotNull(l2);
		assertEquals(1, l2.size());
	}
	...
	public void testNoPermission() {
		...
		VisibilityDomain vd = mock.makeVisibility();
		vd.setVisibility(VisibilityType.PRIVATE);
		visibilityDAO.save(vd);
		...
		// No item category
		List l2 = itemDAO.findFriendItems(authenticated, CategoryType.RECOMMEND,
				person, Arrays.asList(new String[] { "Khim" }), 0);
		assertNotNull(l2);
		assertEquals(0, l2.size());
	}
