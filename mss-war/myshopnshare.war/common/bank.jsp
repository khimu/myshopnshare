<%@ include file="/WEB-INF/jsp/includes.jsp"%>
    ...
    <ul id="category" style="display: none;">
    	...
    	<c:forEach items="${person.rewardsPerVendor}" var="rewardsPerVendor">
 	        <li><a href="#" onclick="showPoints('');" title="Points are reedemable for rewards items offered by specific merchants of those reward points.">${rewardsPerVendor}</a></li>    	
    	</c:forEach>
    	<li>Total Points</li>
