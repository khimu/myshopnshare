...
<script type="text/javascript">
	$(document).ready( function() {					
		...
		$('#registerSubmit').click(function(){
			if(!isZIPCode($('#institutionForm').find('#postalCode').val())){
				Boxy.alert('Zip/Postal Code is required');
				return false;
			}
		});

		var v = $("#institutionForm").validate( {
			rules : {
				firstname :"required",
				lastname :"required",
				month :"required",
...
<div id="main" class="box">
    ...
    <div id="page-in" class="box">		
        ...
        <%-- Content --%>
        <div id="content">	
        	<p id="breadcrumbs"><a href="/register.do">User</a> &nbsp;&nbsp; <a href="/merchantRegister.do">Merchant</a> &nbsp;&nbsp; <a href="/employerRegister.do">Business</a> &nbsp;&nbsp; <strong><a href="/institutionRegister.do"><big>Institution</big></a></strong></p>
            <hr class="noscreen" />
			...
			<div id="center">
			<form:form id="institutionForm" commandName="register" action="/institutionRegister.do" method="post">
			<div class="register">
				...
				<div class="registerDIV">
					...
					<div><form:input id="firstname" path="institution.firstName" /></div>
					<div style="white-space: nowrap; width: 100px"><span class="asterisk">*</span><label for="lastname">Administrator Last Name</label></div>
					<div><form:input id="lastname" path="institution.lastName" /></div>
					<div style="white-space: nowrap; width: 100px"><span class="asterisk">*</span><label for="institutionName">Institution Name</label></div>
					<div><form:input id="institutionName" path="institution.institutionName" /></div>
					<div style="white-space: nowrap; width: 100px"><span class="asterisk">*</span><label for="institutionType">Institution Type</label></div>
					<div><form:select path="institutionType">
					...
					<div class="field"><span class="asterisk">*</span><label for="confirm_password">Confirm Password</label></div>
					<div class="value"><form:password id="confirm_password" path="confirmPassword" /></div>

					<div style="vertical-align: top;"><label for="schooldistrict">School District</label></div>
					<div>
						<form:input id="schooldistrict" path="institution.schoolDistrict" />	
					</div>

					<div style="vertical-align: top;"><label for="tags">Specialization</label></div>
					<div>
			...
			<div class="registerBottom">		
				<div style="padding-top:5px;padding-bottom:5px;">
					Address Permission
					<form:radiobutton path="visibility" value="PRIVATE" /> PRIVATE
					&nbsp;&nbsp; 
					<form:radiobutton path="visibility" value="PUBLIC" /> PUBLIC
				</div>	
				...
				<div style="vertical-align: top;"><label for="schooldistrict">Description</label></div>
				<div>
					<form:textarea id="description" path="institution.description" rows="4" cols="40"/>	
				</div>	
