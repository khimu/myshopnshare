...
(function($) {
	$.fn.prettyPhoto = function(settings) {
		...
		function _fitToViewport(width,height){
			...
			$('div.pp_pic_holder .pp_details').width('550'); /* To have the correct height */
		...
		function _showTitle(){
			if(settings.showTitle && hasTitle){
				...
				$('div.ppt div.ppt_content').css('width','550px');
		...
		function _buildOverlay(){
			...
			pictureHolder = '<div class="pp_pic_holder"><div class="pp_top"><div class="pp_left"></div><div class="pp_middle"></div><div class="pp_right"></div></div><div class="pp_content"><a href="#" class="pp_expand" title="Expand the image">Expand</a><div class="pp_loaderIcon"></div><div class="hoverContainer"></div><div id="full_res"><img id="fullResImage" src="" /></div><div class="pp_details clearfix"><a class="pp_close" href="#">Close</a><p class="pp_description"></p><div class="clear"></div><div class="pp_nav"><a href="#" class="pp_arrow_previous">Previous</a><p class="currentTextHolder">0'+settings.counter_separator_label+'0</p><a href="#" class="pp_arrow_next">Next</a></div></div></div><div class="pp_bottom"><div class="pp_left"></div><div class="pp_middle"></div><div class="pp_right"></div></div></div>';
