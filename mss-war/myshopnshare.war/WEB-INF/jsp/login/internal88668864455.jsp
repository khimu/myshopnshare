...
<%@ include file="../public/header.jsp" %>
     ...
     <div id="tabs" class="noprint">
            ...
            <ul class="box">
            	...
            	<li><a href="/register.do">User<span class="tab-l"></span><span class="tab-r"></span></a></li>
            	<li id="active"><a href="#">Business<span class="tab-l"></span><span class="tab-r"></span></a></li> <%-- Active --%>
                <li><a href="/institutionRegister.do">Institution<span class="tab-l"></span><span class="tab-r"></span></a></li>
                <li><a href="/merchantRegister.do">Merchant<span class="tab-l"></span><span class="tab-r"></span></a></li>
    ...
    <div id="page-in" class="box">
        ...
        <div id="strip" class="box noprint">
            <%-- Breadcrumbs --%>
            <p id="breadcrumbs">You are here: <a href="#">Register</a> &gt; <a href="#">Business</a> &gt;  <strong></strong></p>
            <hr class="noscreen" />
        ...
        <div id="content">	
			...
			<div id="center">
			<form:form id="employerForm" commandName="register" action="/admin/internal.do" method="post">
			<div class="register">
