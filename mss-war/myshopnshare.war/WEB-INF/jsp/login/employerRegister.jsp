...
<div id="main" class="box">
    ...
    <div id="page-in" class="box">
        ...
        <%-- Content --%>
        <div id="content">	
       	 	<p id="breadcrumbs"><a href="/register.do">User</a> &nbsp;|&nbsp; <a href="/merchantRegister.do">Merchant</a> &nbsp;|&nbsp; <strong><a href="/employerRegister.do"><big>Business</big></a></strong> &nbsp;|&nbsp; <a href="/institutionRegister.do">Institution</a></p>
            <hr class="noscreen" />
