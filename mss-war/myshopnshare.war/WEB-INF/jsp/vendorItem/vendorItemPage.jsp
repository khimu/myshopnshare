...
<div id="user-item-page">
	<div id="vendor-item-back-page" class="item-inner-wrap" style="height:50px;width:940px; background-image: url(/images/forsale.png); background-repeat: no-repeat;background-position:center;"><a href="#" onclick="backToSearch()"><img src="/images/back.png" /></a></div>	
