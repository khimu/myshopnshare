...
public class BuyOrderController extends MultiActionController {
	@Autowired
	...
	public ModelAndView view(HttpServletRequest request,
		...
		return new ModelAndView("orders/buys");
	}
	...
	public ModelAndView submitReturn(HttpServletRequest request,
			HttpServletResponse response) throws Exception {
		Person person = fetchPerson();
	...
	public ModelAndView update(HttpServletRequest request,
		...
		EmailUtil.INSTANCE.sendMail("Your order has been shipped", "Invoice: "
				+ itemOrderDetail.getInvoice() + "\nTracking Number: "
				+ trackingNumber, itemOrderDetail.getPerson()
				.getPrimaryEmailAddress().getEmail(), person
				.getPrimaryEmailAddress().getEmail());
