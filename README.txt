...
insert into role values(null, "", 'ROLE_MERCHANT');

insert into role values(null, "", 'ROLE_EMPLOYER');

insert into role values(null, "", 'ROLE_AD');

http://localhost:8080/register.do?ajax=true

only works with tomcat server 5 or 6

kim2kim@gmail.com
password

http://localhost:8080/secure/subscribe.do
http://localhost:8080/public/publicPage.do

// takes you to subscription page
http://localhost:8080/home.do

// main page
http://localhost:8080/secure/home.do

Need to change subscribed = 1 in person table.
subscriptionType is not created properly due to not specifiying names in pojos
...
INSERT INTO `app_user` (`id`, `account_expired`, `account_locked`, `address`, `city`, `country`, `postal_code`, `province`, `credentials_expired`, `email`, `account_enabled`, `password`, `username`, `version`) VALUES
(1, b'0', b'0', NULL, NULL, NULL, NULL, NULL, b'0', 'kim2kim@gmail.com', b'1', '011c945f30ce2cbafc452f39840f025693339c42', 'kim2kim@gmail.com', 0);
...
ALTER TABLE `person`
  ADD CONSTRAINT `FKC4E39B552302BA74` FOREIGN KEY (`username`) REFERENCES `app_user` (`id`);
...
ALTER TABLE `user_role`
  ADD CONSTRAINT `FK143BF46A2A141FAD` FOREIGN KEY (`user_id`) REFERENCES `app_user` (`id`),
