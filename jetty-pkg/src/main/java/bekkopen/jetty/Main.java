...
public class Main {
    ...
    public Main() {
        ...
        secret = System.getProperty("jetty.secret", "e177cf401a3154c551096d4cb89b7267");
    }
    ...
    private void start() {
        ...
        try {
            ...
            //add in the jmx hooks :P
            MBeanContainer mbContainer=new MBeanContainer(ManagementFactory.getPlatformMBeanServer());
            srv.getContainer().addEventListener(mbContainer);
            ...
            String[] vHosts = new String[]{"127.0.0.1", "localhost", "www.myshopnshare.com", "www.fireultralounge.com", "www.thegirlslounge.com"};
